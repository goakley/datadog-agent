...
const (
	...
	// ReplicaSetControllerTagName represents the ReplicaSetController tag name
	ReplicaSetControllerTagName = "kube_replication_controller"
...
var KindToTagName = map[string]string{
	...
	ReplicationControllerKind: ReplicaSetControllerTagName,
